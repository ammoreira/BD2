<html>
	<head>
	     <title>
		    InforTurist -  Cadastro de Cidades
		 </title>
	</head>
	<body>
	<br><br><br><br><br><br><br><br><br><br><br><br><br><br>
		...
		<center>
			...
			<form method = "POST" action="PHP/cadastroCidadeAction.php" border=1>
				...
				Popula&ccedil;&atilde;o &nbsp;&nbsp;&nbsp;<input type="Text" name="cidadePopulacao"><br>
				Estado &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
				<select name="Estados">
				...
				<option value="PQ">Par&aacute;</option>
				...
				<option value="SC">S&atilde;o Paulo</option>
